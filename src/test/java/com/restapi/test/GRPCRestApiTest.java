...
public class GRPCRestApiTest {
	public static final Log log = LogFactory.getLog(GRPCRestApiTest.class);
	private static final String COURSE_URL = "http://localhost:8082/restapi/course/1";
	private static final String ALL_COURSES_URL = "http://localhost:8082/restapi/course";
	@Autowired
	private RestTemplate restTemplate;
	private void assertResponse(String response) {
		//log.info("GRPCRestApiTest response: "+response);
...
*/		assertThat(response, containsString("phone"));
	...
	private InputStream executeHttpRequest(String url) throws IOException {
		CloseableHttpClient httpClient = HttpClients.createDefault(); // HTTP/1.1
	...
	public void GetOneCourseUsingRestTemplate() throws IOException {
		...
		List<String> connections = headers.getConnection();
		log.info("GetOneCourseUsingRestTemplate(): response headers: "+ headers.toString());
		log.info("GetOneCourseUsingRestTemplate(): response headers: upgrade: "+ upgrade);
		log.info("GetOneCourseUsingRestTemplate(): response headers: connections: "+ connections);
		*/
	}
	@Test
